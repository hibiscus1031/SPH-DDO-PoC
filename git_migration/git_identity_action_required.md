...
The current audited commit is `56e2a45d81972d1472c0526a15e36213ec072307`. Its author and committer identity is `谢槿博 <xiejinbo@Jinbo-Mac.local>`. This host-derived address is historical metadata and is not accepted as the future publishing identity.
...
```bash
git -C /Users/xiejinbo/Documents/SPH-DDO-PoC config --local user.name "hibiscus1031"
git -C /Users/xiejinbo/Documents/SPH-DDO-PoC config --local user.email "2623839613@qq.com"
git -C /Users/xiejinbo/Documents/SPH-DDO-PoC config --local --get user.name
git -C /Users/xiejinbo/Documents/SPH-DDO-PoC config --local --get user.email
```
